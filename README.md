...
> **Lineage:** Built for Clawdbot (codename: Zoid), a personal AI agent system. [OpenClaw](https://github.com/openclaw/openclaw) is its public successor. Path references like `~/clawd/` reflect that system layout.
